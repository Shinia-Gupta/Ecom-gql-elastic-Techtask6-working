        ...
        <div className="flex items-center flex-col w-full">
            ...
            {searchBarVisible && (
                <div className="flex gap-2 w-full md:hidden">
                    ...
                    data-test="search-inputForm"
                        ...
                        placeholder="Search..." 
                    />
                    <Button onClick={handleSearch} data-test="search-button-mobile">Search</Button>
                </div>
            )}
            ...
            <div className="relative hidden md:flex w-full justify-center items-center">
                    ...
                    <input 
                        ...
                        placeholder="Search..." 
                    />
                    <Button data-test="search-button" onClick={handleSearch}>Search</Button>
                </div>
            </div>
        </div>
    );
