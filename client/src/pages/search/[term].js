                ...
                <form className="mt-4">
                  {filters.map((section) => (
                    ...
                    >
                      {({ open }) => (
                        <>
                          <DisclosureButton className="w-full flex items-center justify-between px-4 text-gray-400 hover:text-gray-500" data-test={`${section.id}-div`}>
                  ...
                  <button
                    ...
                    data-test='apply-filters-button-mobile'
                  >
                    Apply Filters
                  </button>
                  <button
            ...
            <div className="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-24">
              ...
              <div className="flex items-center">
                <Menu as="div" className="relative inline-block text-left">
                  <MenuButton data-test='sort-dropdown-button' className="group inline-flex justify-center text-sm font-medium text-gray-700 hover:text-gray-900">
                    Sort
                    <ChevronDownIcon
                  ...
                  <MenuItems className="absolute right-0 z-10 mt-2 w-40 origin-top-right bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                    <div className="py-1">
                      <MenuItem>
                        {({ active }) => (
                          <button data-test='low-high-sort-button'
                      ...
                      <MenuItem>
                        {({ active }) => (
                          <button data-test='most-popular-sort-button'
                            onClick={() =>
                ...
                >
                  ...
                  <FunnelIcon className="h-5 w-5" aria-hidden="true" data-test="filters-mobile-button" />
                </button>
              </div>
            </div>
